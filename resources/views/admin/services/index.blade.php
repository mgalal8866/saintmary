                ...
                <thead>
                    <tr>
                       ...
                       {{-- <th>
                        ...
                        {{-- <th>
                            {{ trans('cruds.service.fields.mainservice') }}
                        </th> --}}
                        <th>
                            &nbsp;
                        </th>
                    ...
                    @foreach($services as $key => $service)
                        <tr data-entry-id="{{ $service->id }}">
                           ...
                           <td>
                            ...
                            {{-- <td>
                                <span style="display:none">{{ $service->mainservice ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $service->mainservice ? 'checked' : '' }}>
                            </td> --}}
                            <td>
                                @can('service_show')
